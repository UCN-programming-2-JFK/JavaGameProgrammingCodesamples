...
public class DraggableMapPanel extends JPanel implements MouseMotionListener, MouseListener {
	...
	private static void createWindowWithPanel(DraggableMapPanel examplePanel) {
